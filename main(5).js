...
async function getComments(postID){
    let getcomments = fetch(`https://jsonplaceholder.typicode.com/posts/${postID}/comments`)
        .then((response) => {return response.json()})
        .then((json) => {console.log(json);});
}
...
async function getUser(userID){
    let getusers = fetch(`https://jsonplaceholder.typicode.com/users/${userID}`)
        .then((response) => {return response.json()})
        .then((json) => {console.log(json);});
}
...
async function getTodosForUser(userID){
    let getuserTodos = fetch(`https://jsonplaceholder.typicode.com/todos/${userID}`)
        .then((response) => {return response.json()})
        .then((json) => {console.log(json);});
}
